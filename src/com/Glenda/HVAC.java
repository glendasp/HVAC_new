...
//For this lab I had help from Andre (Learning Center) and Hebert (Classmate)
public class HVAC {
    ...
    public static void main(String[] args) {
        ...
        while (!quit) {//Criando loop para imprimir menu e seguir com as outras opcões
            ...
            switch (choice) {
                ...
                case 2: {
                    //Resolve service call Option
                    //Remove do head da queue
                    ...
                    resolvedCall.setResolvedDate(new Date());  //default data resolvida

                    //Adiciona essa chamada na list de resolvidos
                    resolvedServiceCalls.add(resolvedCall);
                    break;

                }
                case 3: {
                    //Imprime o proximo servico
                    //O que esta no inicio da queue
                    if (todayServiceCalls.isEmpty()) {
                        System.out.println("No service calls today");
                        break;
                    } else {
                ...
                case 5: { // imprime todos os sevicos que nao foram resolvidos
    ...
    private static void addServiceCall() {
        ...
        //Pergunta que tipo de servico deseja
    ...
    //MEtodo que verifica se o numero é negativo
